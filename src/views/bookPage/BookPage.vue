  ...
  <div class="book-page">
    ...
    <div class="centerCol">
      ...
      >
        ...
        <div class="pr-5">
          ...
          <p class="bookDetails__p mb-10">
            <b>
              ...
              bibliophile's delight. Witty and irreverent, funny and sad, this
              is a charming tribute to stories on the page and in our lives--and
              the powers they can hold over us."
              <br />—Matthew Sullivan author of Midnight at the Bright Ideas
              Bookstore "Burns fiercely with love and hurt. A rare and beautiful
              novel. <br />"—Linda Green, bestselling author of While My Eyes
              Were Closed</b
            >
          </p>
        </div>
        ...
        >
          <!-- Print length -->
          <li class="a-carousel__li flex flex-col items-center justify-around">
        ...
        <div class="mt-[3%] ml-[3%]">
          ...
          <a href="#"
          class="flex flex-row items-center link"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              width="24"
      ...
      <div class="bookPrice flex flex-col items-center py-10 px-5">
        ...
        <div class="flex flex-col items-center">
          ...
          <span class="bookPrice__span mt-5 text-center"
            ...
            <b>you're purchasing a license to the content</b> and you agree to
            the
