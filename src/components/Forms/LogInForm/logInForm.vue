  ...
  <!-- Login -->
    ...
    >
      ...
      <div class="Login-forgotPassword ml-10 self-start">
        <RouterLink to="/LogIn/forgotForm">Forgot password?</RouterLink>
      </div>
      <!-- bottom Buttons -->
      <div
      ...
      >
        ...
        <RouterLink to="/LogIn/signUpForm"  class="createAccount__a" @click="changeForm()">Sign up</RouterLink>
      </div>
    </section>
</template>
...
data(){
  ...
  methods: {
    changeInputType() {
     if (this.$refs.LoginPassword.type == "password") {
